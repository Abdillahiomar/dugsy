{{-- resources/views/livewire/dashboard/widgets/stats-grid.blade.php --}}

<div class="kpi-grid">
    @forelse ($kpis as $kpi)
        <div class="kpi-card kpi-{{ $kpi['color'] }}">
            <div class="kpi-icon icon-{{ $kpi['color'] }}">
                @switch($kpi['icon'])
                    @case('users')
                    ...
                    @case('star')
                        ...
                        @break
                    @default
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10"/></svg>
                @endswitch
            </div>
    ...
    @empty
        <div style="grid-column:1/-1;padding:2rem;text-align:center;font-size:.875rem;color:var(--dsh-muted);">
